...
import org.usfirst.frc.team78.robot.subsystems.Pneumatics;
...
public class Robot extends IterativeRobot {
    ...
    public void robotInit() {
		oi = new OI();
		SmartDashboard.putNumber("GyroVal", Robot.chassis.getGyro());
		Robot.pneumatics.compressor.setClosedLoopControl(true);
		Robot.pneumatics.sol_1.set(DoubleSolenoid.Value.kReverse);
		Robot.pneumatics.sol_2.set(DoubleSolenoid.Value.kReverse);
		Robot.pneumatics.sol_3.set(DoubleSolenoid.Value.kReverse);
		
		//SmartDashboard.getNumber("GyroVal", 0);
